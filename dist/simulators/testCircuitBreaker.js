...
async function runCircuitBreakerTest() {
    ...
    const initialRes = await axios_1.default.get(`${BASE_URL}/health-check`);
    ...
    for (let i = 1; i <= 5; i++) {
        const dropRes = await axios_1.default.post(`${BASE_URL}/simulate-drop`, {
    ...
    const trippedRes = await axios_1.default.get(`${BASE_URL}/health-check`);
    ...
    const healedRes = await axios_1.default.get(`${BASE_URL}/health-check`);
