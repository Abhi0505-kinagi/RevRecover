...
class LegalNoticeService {
    ...
    static calculatePenalty(principalPaise, dueDateStr, annualRate = 0.18, lateFeeFlatPaise = 100000) {
        ...
        return {
            daysOverdue,
            interestAccruedFormatted: (0, razorpay_1.formatRazorpayAmount)(interestAccruedPaise),
            lateFeeFormatted: (0, razorpay_1.formatRazorpayAmount)(lateFeeFlatPaise),
            totalPayableFormatted: (0, razorpay_1.formatRazorpayAmount)(totalPayablePaise),
            principalFormatted: (0, razorpay_1.formatRazorpayAmount)(principalPaise),
            interestAccruedPaise,
            totalPayablePaise,
        };
    }
    static async dispatchDemandNotice(payload) {
        ...
        const penalty = this.calculatePenalty(payload.principalAmount, payload.breachedPtpDate || payload.originalDueDate, payload.annualInterestRate || 0.18, payload.lateFeeFlatPaise || 100000);
        const emailHtml = `
...
exports.LegalNoticeService = LegalNoticeService;
